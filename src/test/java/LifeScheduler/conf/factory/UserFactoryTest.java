...
public class UserFactoryTest extends TestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        hobby1 = HobbyFactory.createHobby(hobbyId, hobbyName, nrDaysOccupied, timeSpentPerActivity);
        ...
        userId = "1";
        calendar = CalendarFactory.createCalendar("1", events);
        ...
        user = UserFactory.createUser(userId, calendar, hobbies, familyAndFriends, favourites, occupation);
    }
